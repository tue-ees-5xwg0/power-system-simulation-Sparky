...
def validate_active_reactive_profiles(
    active_load_profiles_path: str, reactive_load_profiles_path: str
) -> tuple[DataFrame, DataFrame]:
    active_load_profiles = validate_load_profile("Active", active_load_profiles_path)
    reactive_load_profiles = validate_load_profile("Reactive", reactive_load_profiles_path)
    validate_profiles_match(active_load_profiles, reactive_load_profiles)
    return active_load_profiles, reactive_load_profiles


def validate_load_profile(Type: str, load_profiles_path: str) -> DataFrame:
    # check string is not empty
...
def validate_profiles_match(active_load_profiles: DataFrame, reactive_load_profiles: DataFrame) -> None:
