...
from GraphTools.graph_processing import GraphProcessor, IDNotFoundError, EdgeAlreadyDisabledError
...
class NMinusOne:
    ...
    def n_minus_one(self, outage_line_id: int) -> pd.DataFrame:
        ...
        try:
            ...
            raise InvalidLineOutageError(str(e))
        except EdgeAlreadyDisabledError as e:
            raise InvalidLineOutageError(str(e))
